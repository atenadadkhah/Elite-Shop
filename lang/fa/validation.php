...
return [
    ...
    */
    ...
    'password' => [
        ...
        'mixed' => ':attribute باید حداقل شامل یک حرف انگلیسی بزرگ و کوچک باشد',
        'numbers' => ':attribute باید حداقل شامل یک عدد باشد',
        'symbols' => ':attribute باید حداقل شامل یک کاراکتر خاص باشد',
        'uncompromised' => ':attribute داده شده در داده های ضعیف ظاهر شده است لطفا یک :attribute دیگر انتخاب کنید',
    ],
